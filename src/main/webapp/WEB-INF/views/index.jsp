...
<body>
	<nav class="navbar navbar-expand-md bg-dark navbar-dark ">
		<div class="container-fluid">
			<a class="navbar-brand" href="<c:url value='/index'/>"> <img
				src="<c:url value='images/maxitech2.png'/>" alt="Logo"
				width="30" height="24" class="d-inline-block align-text-top">MAXITECH
			</a>
	...
	<div class="container-xpand">
		...
		<nav class="navbar navbar-expand-md bg-secundary navbar-secundary">
		...
		<div id="carouselExampleCaptions" class="carousel slide">
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img src="<c:url value='images/maxitech4.PNG'/>"
